...
SECRET_KEY = 'django-insecure-+^$dw2f-8x&-0^-_=*a#@d-k8#)ko2+hnblh=#do84-iw66c#%'
...
ROOT_URLCONF = 'machakos_hackfest.urls'
...
WSGI_APPLICATION = 'machakos_hackfest.wsgi.application'
